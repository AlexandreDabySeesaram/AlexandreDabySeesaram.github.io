...
With the goal of building a digital twin of the lung, a key requirement is to be able to handle a wide variety of patient's geometries without running new costly computations. To that aims, reducing the dimensionality in which the shape variety of shape is expressed appears crucial. Staring from a generic lung shapes, the variety of encoutered shapes is expressed as a familly of mapping from the generic shape to each specific patient morphology.
...
##### {{< iconify fa-solid:vr-cardboard >}} &nbsp; Parametric interactive results
...
**Authors:** <a href="https://m3disim.saclay.inria.fr/people/katerina-skardova/">K. Škardová<a>,  <a href="index.qmd">A. Daby-seesaram<a>, <a href="https://mgenet.github.io/">M. Genet<a>  
